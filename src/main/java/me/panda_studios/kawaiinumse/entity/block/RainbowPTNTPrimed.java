...
public class RainbowPTNTPrimed extends Entity {
    private static final EntityDataAccessor<Integer> DATA_FUSE_ID = SynchedEntityData.defineId(PrimedTnt.class, EntityDataSerializers.INT);
    private static final int DEFAULT_FUSE_TIME = 80;
    @Nullable
    private LivingEntity owner;

    public RainbowPTNTPrimed(EntityType<? extends RainbowPTNTPrimed> p_32076_, Level p_32077_) {
        super(p_32076_, p_32077_);
        this.blocksBuilding = true;
    }

    public RainbowPTNTPrimed(Level p_32079_, double p_32080_, double p_32081_, double p_32082_, @Nullable LivingEntity p_32083_) {
        this(EntitySetup.RAINBOW_POWERED_TNT.get(), p_32079_);
    ...
    protected void explode() {
        this.level.explode(this, this.getX(), this.getY(0.0625D), this.getZ(), 16.0F, Explosion.BlockInteraction.BREAK);
    }
