...
public class EntityNumseEnergy extends EntityThrowable {
    ...
    protected void onImpact(MovingObjectPosition par1MovingObjectPosition)
    {
        ...
        {
            par1MovingObjectPosition.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, this.shootingEntity), damage); // func_85052_h
                                                                                                                                    // =
                                                                                                                                    // thrower
        }
        ...
        /*
         * for (int i = 0; i < 16; i++) { Minecraft mc =
         * ModLoader.getMinecraftInstance(); Object obj = null;
         * mc.effectRenderer.addEffect(((EntityFX)(obj = new
         * EntityBreakingFX(worldObj, posX, posY, posZ,
         * mod_Numse.energyBall)))); }
         */
