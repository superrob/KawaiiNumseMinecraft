...
public class EntityLargeExplodeRainbowFX extends EntityFX
{
    ...
    public EntityLargeExplodeRainbowFX(RenderEngine par1RenderEngine, World par2World, double par3, double par5, double par7, double par9, double par11, double par13)
    {
