...
public class EntityRainbowPowerTNTPrimed extends Entity
{
    /** How long the fuse is */
    public int fuse;
    public Set destroyedBlockPositions;

    public EntityRainbowPowerTNTPrimed(World par1World)
    {
        super(par1World);
        fuse = 0;
    ...
    public EntityRainbowPowerTNTPrimed(World par1World, double par2, double par4, double par6)
    {
        this(par1World);
