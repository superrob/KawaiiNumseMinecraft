...
public class NumseMod {
    ...
    public void preInit(FMLPreInitializationEvent event) {
		rainbowPowder = new Item(2500)
				.setUnlocalizedName("rainbowPowder")
				.setCreativeTab(CreativeTabs.tabMaterials)
				.setTextureName("numsemod:rainbowpowder");
		...
		rainbowBlock = (new Block(820, Material.cloth))
				.setStepSound(new StepSound("cloth", 1.0F, 1.0F))
				.setHardness(0.7F)
				.setCreativeTab(CreativeTabs.tabBlock)
				.setTextureName("numsemod:rainbowblock");
		...
		rainbowBar = new Item(2504)
				.setUnlocalizedName("Rainbow bar")
				.setMaxStackSize(64)
				.setCreativeTab(CreativeTabs.tabMaterials)
		...
		rainbowCore = new ItemPowerCore(2505)
		...
		chili = (new ItemFood(2501, 5, 0.8F, false)
				.setPotionEffect(Potion.damageBoost.id, 30, 2, 1.0F)
				.setAlwaysEdible()
				.setUnlocalizedName("Chili"))
				.setTextureName("numsemod:chili");
		LanguageRegistry.addName(chili, "Chili");
		GameRegistry.registerItem(chili, "chili");
		
		rainbowCookie = (new ItemFood(2502, 2, 0.3F, false)
				.setPotionEffect(Potion.regeneration.id, 5, 1, 1.0F)
				.setUnlocalizedName("Rainbow cookie"))
		...
		energyBall = new ItemEnergyball(2503)
		...
		energyRifle = new ItemEnergyrifle(2506)
				.setUnlocalizedName("Energyrifle")
				.setCreativeTab(CreativeTabs.tabCombat)
				.setTextureName("numsemod:energyrifle");
		...
		GameRegistry.addSmelting(rainbowPowder.itemID, rainbowBarStack, 0.2f);
	...
	Minecraft mc = ModLoader.getMinecraftInstance();
			...
			ModLoader.addRecipe(new ItemStack(NumseMod.rainbowTNT, 1), new Object [] {
                "ABA", "BAB", "ABA", Character.valueOf('A'), NumseMod.rainbowPowder, Character.valueOf('B'), Block.sand
	        });
	        
			ModLoader.addRecipe(new ItemStack(NumseMod.rainbowPowerTNT, 1), new Object [] {
                "CBC", "BAB", "CBC", Character.valueOf('A'), NumseMod.rainbowCore, Character.valueOf('B'), Block.sand, Character.valueOf('C'), Item.gunpowder,
	        });
